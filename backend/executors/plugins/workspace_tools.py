...
# Tool parameter schemas live separately from handlers and registration.
from executors.plugins.workspace_tool_models import (
    ReadFileParams, SliceReadParams, RunCodeParams, WriteFileParams,
    SingleEdit, EditFileParams, ReadAnchoredParams, AnchoredEditItem,
    EditAnchoredParams, ListWorkspaceParams, RunSkillParams, RunShellParams,
    ReadLocalFileParams, WriteLocalFileParams, SpawnAgentParams,
