...
MEMORY_PROJECTION_ROLLOUT_MIN_OBSERVATION_SECONDS = float(
    os.environ.get("NUKE_MEMORY_PROJECTION_ROLLOUT_MIN_OBSERVATION_SECONDS")
    or 300
)
MEMORY_PROJECTION_ROLLOUT_MIN_AUDIT_INTERVAL_SECONDS = float(
    os.environ.get("NUKE_MEMORY_PROJECTION_ROLLOUT_MIN_AUDIT_INTERVAL_SECONDS")
    or 30
)
MEMORY_PROJECTION_ROLLOUT_REOPEN_COOLDOWN_SECONDS = float(
