...
export default function DiscussionPanel({ groupBots = [], onStart, onClose }) {
  ...
  return (
    <div className="space-y-4 text-left">
      <p className="text-gray-400 text-xs">
        选择多个 Bot 参与公开讨论，设定辩论轮次，并指派一位 summarizer bot 进行最后的总结与客观评估。
      </p>
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-12 bg-gray-855 text-white text-center text-xs rounded border border-gray-700 py-0.5 outline-none focus:ring-1 focus:ring-indigo-500"
            />
          </div>
        </div>
